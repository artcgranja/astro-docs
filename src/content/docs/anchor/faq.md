...
:::note[What Python version is required?]
anchor requires Python 3.10 or later.
:::

:::note[How do I install optional dependencies?]
...
:::note[How do I handle errors in pipeline steps?]
...
:::note[What embedding functions are supported?]
